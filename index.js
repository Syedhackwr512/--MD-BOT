...
if (!fs.existsSync(CREDS)) {
  ...
  if (!session.includes("𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD~")) {
    console.log("❌ Invalid 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD session format");
    process.exit(1);
  }
  ...
  console.log("♻️ 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD session restored successfully");
}
...
app.get('/', (req, res) => {
  ...
  if (fs.existsSync(htmlPath)) {
    ...
    res.send(`
      ...
      <html>
      <head>
        <title>𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD Bot</title>
        <style>
...
async function connectToWA() {
  ...
  console.log(`🤖 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD Connecting with prefix: "${prefix}"`);
  ...
  sock.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log("✅ 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD Bot connected to WhatsApp!");
      ...
      const aliveMsg = `*╭──────────────●●►*\n> *𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD CONNECTED SUCCESSFULLY*\n\n> *Type ${prefix}menu to view commands*  \n\n*╭⊱✫ 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑 MD ✫⊱╮*\n*│✫📂 Bot Name: ${botConfig.BOT_NAME}*\n*│✫🛡️ Owner: ${config.OWNER_NAME}*\n*│✫♻️ Prefix: ${prefix}*\n*│✫🌍 Mode: ${config.MODE}*\n*│✫⏰ Uptime: ${runtime(process.uptime())}*\n*╰──────────────●●►*\n\n> Enjoy Using 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑 MD`;
      
      // Image URL for connection message
      const imageUrl = 'https://cdn.phototourl.com/free/2026-09-17-f86254b3-20ee-4b1c-9dcd-0ccd5fd2f8f0.jpg';
