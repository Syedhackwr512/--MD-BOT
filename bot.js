...
REPO_LINK: process.env.REPO_LINK || "https://github.com/Arslan-MD/𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD",
REPO_NAME: process.env.REPO_NAME || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD",
BOT_NAME: process.env.BOT_NAME || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD",
DESCRIPTION: process.env.DESCRIPTION || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑 MD PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "923405452377",
OWNER_NAME: process.env.OWNER_NAME || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑 Official",
ST_SAVE: process.env.ST_SAVE || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD-BY-𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD`* _*POWERD BY*_ *𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑 Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄-MD BY 𝐒𝐘𝐄𝐃 𝐇𝐀𝐂𝐊𝐄𝐑-MD OFFICIAL*",
